...
function family_grows_theme_page_options_setup() { ?>
    ...
    <p>
        <?php esc_html_e('Here are some plugin recommendations that I think it would be suited for when using this theme.', 'family-grows'); ?>
    </p>
    <ul>
        <li>
    ...
    <h2><?php esc_html_e('General Layouts', 'family-grows'); ?></h2>
    <p>
        <?php esc_html_e('When working with the general layouts, there are 3 different types of layouts. Here is how it works!', 'family-grows'); ?>
    </p>
    <ul>
        <li>
            <b><?php esc_html_e('Post Layout', 'family-grows'); ?></b><br />
            <?php esc_html_e('Post Layouts has three different layouts, left, right and no sidebar which considered as full width content. Post layouts will only show in single posts and does not show in blog index.', 'family-grows'); ?>
        </li>
        <li>
            <b><?php esc_html_e('Page Layout', 'family-grows'); ?></b><br />
            <?php esc_html_e('Page Layout has three different layouts, left, right and no sidebar which considered as full width content. Page layout will only show in page and custom templates.', 'family-grows'); ?>
        </li>
        <li>
            <b><?php esc_html_e('Custom Layout', 'family-grows'); ?></b><br />
            <?php esc_html_e('Custom Layout has three diffrent layouts, left, right, and no sidebar which considered as full width content. Custom layout is used only in custom sidebar template', 'family-grows'); ?>
        </li>
    </ul>
<?php } 