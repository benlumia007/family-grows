...
/*
===========================================================================================================
Family Grows - control-radio-image.php
===========================================================================================================
The customizer.php gives the user the ability to change features within the customizer. This has been setup 
to allow users to set different layouts within the theme and other features that the WordPress functionality 
is included.
...
===========================================================================================================
*/
function family_grows_control_radio_image_class_setup() {
    class Family_Grows_Control_Radio_Image extends WP_Customize_Control {
        public $type = 'radio-image';
        
        public function enqueue() {
            wp_enqueue_script('family-grows-customize-controls', get_template_directory_uri() . '/js/control-radio-image.js', array('jquery'));
            wp_enqueue_style('family-grows-customize-controls', get_template_directory_uri() . '/css/control-radio-image.css');
        }
...
add_action('customize_register', 'family_grows_control_radio_image_class_setup');
...
===========================================================================================================
*/
function family_grows_control_radio_image_layout_setup($wp_customize) {
    $wp_customize->add_panel('general_layouts', array(
        'title'     => esc_html__('General Layouts', 'family-grows'),
        'priority'  => 5,
    ));
    
    /*
    =======================================================================================================
    Enable and activate Post Layout for Family Grows. The Post Layout should only be used under posts and
    Archives.
    =======================================================================================================
    */    
    $wp_customize->add_section('post_layout', array(
        'title'     => esc_html__('Post Layout', 'family-grows'),
    ...
    $wp_customize->add_setting('post_layout', array(
        'default'           => 'no-sidebar',
        'sanitize_callback' => 'family_grows_sanitize_layout',
        'transport'         => 'refresh',
        'type'              => 'theme_mod',
    ));
    ...
    /*
    =======================================================================================================
    Enable and activate Page Layout for Family Grows. The Page Layout should only be used under Pages that 
    is registered as part of the theme.
    =======================================================================================================
    */
    $wp_customize->add_section('page_layout', array(
        'title'     => esc_html__('Page Layout', 'family-grows'),
        'panel'     => 'general_layouts',
        'priority'  => 5,
    ));
    ...
    /*
    =======================================================================================================
    Enable and activate Custom Layout for Family Grows. The Custom Layout should only be used under Custom 
    Templates that is registered as part of the theme.
    =======================================================================================================
    */
    $wp_customize->add_section('custom_layout', array(
        'title'     => esc_html__('Custom Layout', 'family-grows'),
        'panel'     => 'general_layouts',
        'priority'  => 5,
    ));
...
add_action('customize_register', 'family_grows_control_radio_image_layout_setup');
...
================================================================================================
*/
function family_grows_sanitize_layout($value) {
